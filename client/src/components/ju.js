...
console.log(`---->
 localhost:4000/consultarLista/empleado`)
...
console.log(`<----
 (OK 200) localhost:4000/consultarLista/empleado`)
...
modificarEmpleado 
: 
this.state.consultarEmpleado.e_id_empleado
...
console.log(`---->
 localhost:4000/eliminar/empleado/${this.state.consultarEmpleado.e_id_empleado}`)
...
console.log(`<----
 (OK 200) localhost:4000/eliminar/empleado`)
...
rowData) 
=> 
this.handleConsultar(rowData.e_id_empleado)}
...
<span>
: {this.state.consultarEmpleado.e_id_empleado.toString(10).padStart(4,
'0')}</span>
</p>	
<p>
...
<span>
: {this.state.consultarEmpleado.e_cedula}</span>
...
<span className="mc-atributo">Nombre
 Completo</span>
...
${this.state.consultarEmpleado.e_nombre}
${this.state.consultarEmpleado.e_segundo_nombre
||
""}
...
${this.state.consultarEmpleado.e_apellido}
${this.state.consultarEmpleado.e_segundo_apellido
||
""}`}</span>
...
<span>
: {this.state.consultarEmpleado.e_telefono}</span>
...
<span>
: {this.state.consultarEmpleado.e_genero
===
"m"
?
"Hombre"
...
<span className="mc-atributo">Fecha
 Nacimiento</span>
...
<span>
: {this.state.consultarEmpleado.e_fecha_nacimiento.split('T')[0]}</span>
...
<span>
: {this.state.consultarEmpleado.e_fecha_ingreso.split('T')[0]}</span>
...
<span>
: {this.state.consultarEmpleado.cargo}</span>
...
<span>
: {this.state.consultarEmpleado.lugar}</span>
...
<span className="mc-atributo">Estado
 Actual</span>
...
<span>
: {this.state.consultarEmpleado.estado}</span>
...
<p style={{textAlign:
"center"}}>{`¿Estas
 segur@ que deseas eliminar a 
${this.state.consultarEmpleado
&&
this.state.consultarEmpleado.e_nombre}?`}</p>
...
<Button variant="primary"
 className="mc-boton mc-boton-guardar"
 onClick={this.handleCloseEliminar}>
...
<Button variant="danger"
 className="mc-boton"
 onClick={this.handleEliminarSeguro}>
...
{this.state.agregarPresionado
&&
<Redirect push to="/crear/empleado"
/>}
