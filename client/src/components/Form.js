     ...
     <div className="wrapper">
        <div className="form-wrapper">
          ...
          <form className="form" noValidate>
            ...
            <div >
            <div className="check" ><input type="checkbox" id="yes" /><label>Si</label></div> 
            <div className="check"><input type="checkbox" /><label>No</label></div> 
            </div>
            </div>
            <div className="ingresarUsuario">
              <button type="submit" onClick={this.handleAddEmpleado} >Ingresar Usuario</button>
            </div>
          </form>
        </div>
      </div>
